---
name: sanity-publishing
description: Enforce title and slug rules when publishing documents to Sanity. Use when creating or updating Sanity documents that have a title and slug, typically via your Sanity MCP tools.
---

# Sanity publishing rules

Apply these rules with your own Sanity tools when writing a document that has a title and slug.
